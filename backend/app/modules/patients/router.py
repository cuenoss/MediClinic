...
async def create_consultation(
    ...
    try:
        ...
        return ConsultationResponse.model_validate(new_consultation)
    except HTTPException:
        raise
    except Exception as e:
        await db.rollback()
...
async def get_patient_files(
    ...
    try:
        ...
        return [AttachedFileResponse.model_validate(file) for file in files]
    except HTTPException:
        raise
    except Exception as e:
...
async def upload_patient_file(
    ...
    try:
        ...
        return AttachedFileResponse.model_validate(new_file)
    except HTTPException:
        raise
    except Exception as e:
        await db.rollback()
